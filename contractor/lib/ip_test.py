...
from contractor.lib.ip import IpIsV4, StrToIp, IpToStr, CIDRNetwork, CIDRNetmask, CIDRNetmaskToPrefix, CIDRNetworkBounds, CIDRNetworkRange
...
def test_cidrnetworkrange():
  assert CIDRNetworkRange( StrToIp( '169.254.1.3' ), 32 ) == [ StrToIp( '169.254.1.3' ) ]
  assert CIDRNetworkRange( StrToIp( '169.254.1.3' ), 32, True ) == [ StrToIp( '169.254.1.3' ) ]
  assert CIDRNetworkRange( StrToIp( '169.254.1.3' ), 32, False ) == [ StrToIp( '169.254.1.3' ) ]
  assert CIDRNetworkRange( StrToIp( '169.254.1.3' ), 31 ) == [ StrToIp( '169.254.1.2' ), StrToIp( '169.254.1.3' ) ]
  assert CIDRNetworkRange( StrToIp( '169.254.1.3' ), 31, True ) == [ StrToIp( '169.254.1.2' ), StrToIp( '169.254.1.3' ) ]
  assert CIDRNetworkRange( StrToIp( '169.254.1.3' ), 31, False ) == [ StrToIp( '169.254.1.2' ), StrToIp( '169.254.1.3' ) ]
  assert CIDRNetworkRange( StrToIp( '169.254.1.3' ), 30 ) == [ StrToIp( '169.254.1.1' ), StrToIp( '169.254.1.2' ) ]
  assert CIDRNetworkRange( StrToIp( '169.254.1.3' ), 30, True ) == [ StrToIp( '169.254.1.0' ), StrToIp( '169.254.1.1' ), StrToIp( '169.254.1.2' ), StrToIp( '169.254.1.3' ) ]
  assert CIDRNetworkRange( StrToIp( '169.254.1.3' ), 30, False ) == [ StrToIp( '169.254.1.1' ), StrToIp( '169.254.1.2' ) ]
  assert CIDRNetworkRange( StrToIp( '169.254.1.3' ), 29 ) == [ StrToIp( '169.254.1.1' ), StrToIp( '169.254.1.2' ), StrToIp( '169.254.1.3' ), StrToIp( '169.254.1.4' ), StrToIp( '169.254.1.5' ), StrToIp( '169.254.1.6' ) ]
  assert CIDRNetworkRange( StrToIp( '169.254.1.3' ), 29, True ) == [ StrToIp( '169.254.1.0' ), StrToIp( '169.254.1.1' ), StrToIp( '169.254.1.2' ), StrToIp( '169.254.1.3' ), StrToIp( '169.254.1.4' ), StrToIp( '169.254.1.5' ), StrToIp( '169.254.1.6' ), StrToIp( '169.254.1.7' ) ]
  assert CIDRNetworkRange( StrToIp( '169.254.1.3' ), 29, False ) == [ StrToIp( '169.254.1.1' ), StrToIp( '169.254.1.2' ), StrToIp( '169.254.1.3' ), StrToIp( '169.254.1.4' ), StrToIp( '169.254.1.5' ), StrToIp( '169.254.1.6' ) ]
  assert CIDRNetworkRange( StrToIp( '2::5' ), 128 ) == [ StrToIp( '2::5' ) ]
  assert CIDRNetworkRange( StrToIp( '2::5' ), 128, True ) == [ StrToIp( '2::5' ) ]
  assert CIDRNetworkRange( StrToIp( '2::5' ), 128, False ) == [ StrToIp( '2::5' ) ]
  assert CIDRNetworkRange( StrToIp( '2::5' ), 127 ) == [ StrToIp( '2::4' ), StrToIp( '2::5' ) ]
  assert CIDRNetworkRange( StrToIp( '2::5' ), 127, True ) == [ StrToIp( '2::4' ), StrToIp( '2::5' ) ]
  assert CIDRNetworkRange( StrToIp( '2::5' ), 127, False ) == [ StrToIp( '2::4' ), StrToIp( '2::5' ) ]
  assert CIDRNetworkRange( StrToIp( '2::5' ), 126 ) == [ StrToIp( '2::5' ), StrToIp( '2::6' ) ]
  assert CIDRNetworkRange( StrToIp( '2::5' ), 126, True ) == [ StrToIp( '2::4' ), StrToIp( '2::5' ), StrToIp( '2::6' ), StrToIp( '2::7' ) ]
  assert CIDRNetworkRange( StrToIp( '2::5' ), 126, False ) == [ StrToIp( '2::5' ), StrToIp( '2::6' ) ]
  assert CIDRNetworkRange( StrToIp( '2::5' ), 125 ) == [ StrToIp( '2::1' ), StrToIp( '2::2' ), StrToIp( '2::3' ), StrToIp( '2::4' ), StrToIp( '2::5' ), StrToIp( '2::6' ) ]
  assert CIDRNetworkRange( StrToIp( '2::5' ), 125, True ) == [ StrToIp( '2::0' ), StrToIp( '2::1' ), StrToIp( '2::2' ), StrToIp( '2::3' ), StrToIp( '2::4' ), StrToIp( '2::5' ), StrToIp( '2::6' ), StrToIp( '2::7' ) ]
  assert CIDRNetworkRange( StrToIp( '2::5' ), 125, False ) == [ StrToIp( '2::1' ), StrToIp( '2::2' ), StrToIp( '2::3' ), StrToIp( '2::4' ), StrToIp( '2::5' ), StrToIp( '2::6' ) ]
